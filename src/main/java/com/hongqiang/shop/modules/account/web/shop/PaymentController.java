...
//    {
//      PaymentPlugin localPaymentPlugin = this.pluginService.getPaymentPlugin(localPayment.getPaymentPluginId());
...
//              this.orderService.payment(localOrder, localPayment, null);
//          }
//          else
//          {
...
//              this.memberService.update(localMember, null, localBigDecimal2, IIIllIlI("shop.payment.paymentName", new Object[] { localPaymentPlugin.getPaymentName() }), null);//base controller 
//            }
//          }
//        }
...
//              {
//                BigDecimal localBigDecimal2 = localPayment.getAmount().subtract(localPayment.getFee());
//                this.memberService.update(localMember, null, localBigDecimal2, IIIllIlI("shop.payment.paymentName", new Object[] { localPaymentPlugin.getPaymentName() }), null);
//              }
//            }
//          }
//          localPayment.setStatus(Payment.Status.success);

...
//  MailService mailService;
  ...
  {
    return this.productNotifyDao.findPage(member, isMarketable, isOutOfStock, hasSent, pageable);
  }

  @Transactional(readOnly=true)
  public Long count(Member member, Boolean isMarketable, Boolean isOutOfStock, Boolean hasSent)
  {
    return this.productNotifyDao.count(member, isMarketable, isOutOfStock, hasSent);
  }

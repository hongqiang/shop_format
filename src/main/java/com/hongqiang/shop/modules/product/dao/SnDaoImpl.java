...
class HiloOptimizer
{
  ...
  public synchronized String generate()
  {
    ...
    return FreeMarkers.renderString(this.prefix, null) + (this.firstValue + this.middleValue++);
  }
}
  ...
  {
    this.product = new HiloOptimizer(this, Sn.Type.product, this.snProductPrefix, this.snProductMaxLo);
    this.order = new HiloOptimizer(this, Sn.Type.order, this.snOrderPrefix, this.snOrderMaxLo);
    this.payment = new HiloOptimizer(this, Sn.Type.payment, this.snPaymentPrefix, this.snPaymentMaxLo);
    this.refunds = new HiloOptimizer(this, Sn.Type.refunds, this.snRefundsPrefix, this.snRefundsMaxLo);
    this.shipping = new HiloOptimizer(this, Sn.Type.shipping, this.snShippingPrefix, this.snShippingMaxLo);
    this.returns = new HiloOptimizer(this, Sn.Type.returns, this.snReturnsPrefix, this.snReturnsMaxLo);
  }

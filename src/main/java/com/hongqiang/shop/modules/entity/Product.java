...
public class Product extends BaseEntity
{
  ...
  static
  {
    ...
    {
    	//file 要修改
      File localFile = new ClassPathResource("classpath:/shophq.xml").getFile();
      Document localDocument = new SAXReader().read(localFile);
      Element localElement = (Element)localDocument.selectSingleNode("/shophq/template[@id='productContent']");
...
//
  ...
  public List<Product> getSiblings()
  {
    ...
    {
      Iterator<Product> localIterator = getGoods().getProducts().iterator();

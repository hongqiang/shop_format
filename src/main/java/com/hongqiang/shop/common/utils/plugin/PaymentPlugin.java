...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	 ...
	 */
	public abstract Map<String, String> getParameterMap(String sn, BigDecimal amount,
	 ...
	 * @return
	 */
	public abstract String getNotifyContext(String sn, HttpServletRequest request);
	...
	protected String getReturnUrl(String sn) {
		...
		return setting.getSiteUrl() + "/payment/return/" + sn+ ".jhtml";
	}
	...
	protected String getNotifyUrl(String sn) {
		Setting setting = SettingUtils.get();
		return setting.getSiteUrl() + "/payment/notify/" + sn+ ".jhtml";
	}

...
<body>
	<div class="path">
		<a href="${base}${adminPath}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.article.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>

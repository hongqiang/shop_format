...
<body>
	<div class="path">
		<a href="${base}${adminPath}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.paymentPlugin.list")} <span>(${message("admin.page.total", paymentPlugins?size)})</span>
	</div>
